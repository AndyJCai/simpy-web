import { STORE_SPOTIFY_INFO, CLEAR_SPOTIFY_INFO } from '../actions/types';
...
export default (state = STARTING_STATE, action) => {
  switch(action.type){
    ...
    case CLEAR_SPOTIFY_INFO:
      return { ...state, displayName: null, profilePic: [], friends: [], spotifyId: null, username: null };
    default:
      return state;
  };
};
